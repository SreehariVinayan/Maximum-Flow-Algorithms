...
def test_simple_two_path_graph():
    # classic textbook example, max flow = 23 (s=0, t=5)
    g = FlowNetwork(6)
...
def test_disconnected_source_sink():
    g = FlowNetwork(3)
    g.add_edge(0, 1, 5)
    # node 2 has no edge at all connecting it to {0,1}
    result = dinic_max_flow(g, 0, 2)
...
if __name__ == "__main__":
    ...
    print("All test_dinic tests passed.")
